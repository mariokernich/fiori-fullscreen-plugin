		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fullescreen",
									"targetURL": "#fiorifullscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorifullscreen-display": {
								"semanticObject": "fiorifullscreen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.kernich.fiori.fullscreen",
									"url": sap.ui.require.toUrl("de/kernich/fiori/fullscreen")
								}
							}
						}
					}
